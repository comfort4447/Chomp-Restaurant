...
// const Navbar = ({id, title, price, details, img}) => {
...
//                             <button className='hero_btn'>Start Order Now</button>
//                         </div>
...
//                             since the 1500.</p>
//                         <button className='hero_btn'>Place an Order</button>
...
//                                                         <button onClick={addToCart(burgerData.id)}  className='hero_btn1' >Add to cart</button>
//                                                     </div>
//                                                 </div>
//                                             </div>
//                                         )
...
//                                                     <button onClick={addToCart(sideData.id)} className='hero_btn1'>Add to cart</button>
//                                                 </div>
//                                             </div>
//                                             </div>
//                                     )
...
//                                             <div className='burger_btn'>
//                                                 <input className='hero_btn3' type="number" id="quantity" name="quantity" min="1" max="100" step="1" />
//                                                 <button onClick={addToCart(drinkData.id)} className='hero_btn1'>Add to cart</button>
//                                             </div>
//                                         </div>
//                                     </div>
//                                 )
...
//                         <button className='hero_btn'>See our FAQ</button>
//                     </div>
//                 </div>
//             </section>
...
//                         <button className='hero_btn2'>Order now</button>
//                     </div>
//                 </div>
//             </section>
//         </>
